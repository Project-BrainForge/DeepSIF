...
def main(region_id):
    ...
    os.makedirs(
        "/Users/pasindusankalpa/Documents/DeepSIF/source/raw_nmmm/a{}/".format(
            region_id
        ),
        exist_ok=True,
    )
    ...
    conn = connectivity.Connectivity.from_file(
        source_file=os.getcwd() + "/../anatomy/connectivity_998.zip"
        ...
        for iter_m in range(mean_and_std.shape[1]):
            ...
            sim = simulator.Simulator(
                ...
                integrator=integrators.HeunStochastic(
                    dt=2**-1, noise=noise.Additive(nsig=sigma)
                ),
            ...
            for iii in range(20):
                print(
                    "Running simulation for region_id {} and iteration {}".format(
                        region_id, iii
                    )
                )
                siml = 1e4
                ...
                savemat(
                    "/Users/pasindusankalpa/Documents/DeepSIF/source/raw_nmm/a{}/mean_iter_{}_a_iter_{}_{}.mat".format(
...
if __name__ == "__ main__":
    ...
    parser.add_argument(
        "--a_start", type=int, default=0, metavar="t/f", help="start region id"
    )
    parser.add_argument(
        "--a_end", type=int, default=1, metavar="t/f", help="end region id"
    )
